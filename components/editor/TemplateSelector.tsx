...
import { Circle, Square, Star, Cross, Church, Cloud } from 'lucide-react'
    ...
    <div className="section-card space-y-3 p-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={cn('type-btn flex-1 py-2 text-xs', type === 'jour' && 'active')}
        >
        ...
        <button
          ...
          className={cn('type-btn flex-1 py-2 text-xs', type === 'saint' && 'active')}
        >
